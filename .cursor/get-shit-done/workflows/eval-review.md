...
```bash
AUDITOR_MODEL=$(node "/Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/michaelweaver/Websites/home-assist/.cursor/agents/gsd-eval-auditor.md for instructions.
