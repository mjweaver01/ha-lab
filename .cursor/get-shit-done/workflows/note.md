...
- **Global scope**: `/Users/michaelweaver/Websites/home-assist/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/michaelweaver/Websites/home-assist/.cursor/notes/`)
...
2. Glob `/Users/michaelweaver/Websites/home-assist/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/michaelweaver/Websites/home-assist/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/michaelweaver/Websites/home-assist/.cursor/notes/` — works in any directory
