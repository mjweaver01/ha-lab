...
Knowledge graph is disabled. To activate:
  ...
  node /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
