...
Intel system is disabled. To activate:
  ...
  node /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/michaelweaver/Websites/home-assist/.cursor/get-shit-done/bin/gsd-tools.cjs intel diff
```
